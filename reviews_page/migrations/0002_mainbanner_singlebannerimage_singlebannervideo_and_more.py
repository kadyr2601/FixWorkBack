...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='review',
            options={'verbose_name': 'Review', 'verbose_name_plural': 'Reviews List'},
        ),
        migrations.CreateModel(
            name='ServiceCard',
            fields=[
                ...
                ('slug', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_services', to='restoration_page.restoration', to_field='slug', verbose_name='Select Restoration')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('main_banner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reviews_page.mainbanner', verbose_name='Main Banner')),
                ('services_banner', models.ManyToManyField(blank=True, related_name='services_banner', to='reviews_page.servicecard', verbose_name='Services Banner')),
                ('single_banner_image', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reviews_page.singlebannerimage', verbose_name='Image Banner')),
                ('single_banner_video', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reviews_page.singlebannervideo', verbose_name='Video Banner')),
            ],
            options={

...
class HomePageView(views.APIView):
    def get(self, request):
        ...
        serializer = serializers.HomePageSerializer(home_page, context={'request': request})
...
class ServiceCardView(views.APIView):
    def get(self, request):
        ...
        serializer = serializers.ServiceCardSerializer(home_page, many=True, context={'request': request})
        return response.Response(serializer.data)
